...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">
    	<a href="cat.php?id=<?php echo $category['serv_cat_id'] ?>">
	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
		   		<h5 class="card-title">
		   			<?php echo $row['title']; ?>
		   			<a href="servReview.php?id=<?php echo $row['id']?>" type="button" class="btn btn-outline-success btn-sm float-right">Оставить отзыв</a>
		   		</h5>
		   		<div class="col-md-4">
			    	<img src="/images/<?php echo $row['image']; ?>" class="card-img float-left mr-4">
			    </div>
