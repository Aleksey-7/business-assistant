...
if (isset($_POST["submit"])) {
	$sql = "Insert into products (request_id, title, description, content, category_id, cost, image) VALUES ('" . $_POST["request_id"] . "','" . $_POST["title"] . "', '" . $_POST["description"] . "', '" . $_POST["content"] . "', '" . $_POST["cost"] . "', '" . $_POST["cat_id"] . "', '" . $_POST["image"] . "')";
	if ($conn->query($sql)) {
