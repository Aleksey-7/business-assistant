...
if (isset($_POST) and $_SERVER["REQUEST_METHOD"]=="POST"){
	...
	if($result->num_rows > 0){
		...
		if($user['verifided'] == "1"){
			...
			// переход на главную
			header('Location: http://busines-assistent.local');
...
<a class="btn btn-outline-info mb-3" href="http://business-assistant.local/registration.php">Регистрация</a>

<a class="btn btn-outline-info ml-3 mb-3" href="http://business-assistant.local/modules/registration/emailConfirmation.php">Верификация E-mail</a>
