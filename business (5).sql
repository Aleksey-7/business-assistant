...
--
-- Хост: 127.0.0.1
-- Время создания: Июл 18 2020 г., 20:25
...
(21, 18, 'KZwOV7G9YvIdwB5', '2020-07-18 15:44:50', 'user@gmail.com', 2),
(22, 18, 'CeBhkV5TPCTR9qb', '2020-07-18 15:51:23', 'user@gmail.com', 2),
(23, 18, '9lDYzDHIJPnNaCM', '2020-07-18 15:52:59', 'user@gmail.com', 1),
(24, 20, 'KGxsVdZfoK1tgKc', '2020-07-18 15:54:44', 'user4@gmail.com', 1),
(25, 20, 's5e0zKw14P0ZGKo', '2020-07-18 16:01:26', 'user4@gmail.com', 1),
(26, 19, 'LQN0fiaL7bsRGg5', '2020-07-18 16:22:20', 'andrey@gmail.com', 1);
...
(1, 0, 'Кафе Мороженное', 500, '15% скидки на все товары', 'Очень вкусное и полезное мороженное, так же присутствует много других вкусняшек. Приходи и приобретай с продукцией отличное настроение.', '', 1),
(2, 0, 'Тибетский массаж', 600, '40% скидки на 10 посещений', 'Лучший тибетский массаж в городе', '', 3);
...
(3, 'Торты', '40% на любое кондитерское изделие', '', 0, '', 150, 2, '0965202547', 'Новый'),
(4, 'Торты', '40% на любое кондитерское изделие', 'К Вашему вниманию – торты(пряники.,капкейки,чизкейки и т. д) на заказ в городе Днепр, на все случаи жизни: Дни рождения (детей и взрослых), юбилеи, свадьбы, корпоративы и др.\r\nНу а если Вам просто вечером стало скучно и захотелось подсластить одиночество чем-то необычным, лень выходить из дома – можно получить торт на заказ. И это – не напрягая силы на поиски и транспортировку кондитерского изделия до дома.', 1, '', 150, 2, '0965202547', 'Новый'),
(5, '', '', '', 0, '', 0, 2, '', 'Новый'),
(6, 'Торты', '40% на любое кондитерское изделие', '\r\n63231056', 7, '3lJjgZ3z6GA.jpg', 0, 2, '', 'Новый');
...
(18, 'user', 'ee11cbb19052e40b07aac0ca060c23ee', 'user@gmail.com', 'User User', '0984657357', 'qNJXATpf7C0w8uuoIiYK', 1, '{\"favorites\":[{\"product_id\":\"1\"},{\"product_id\":\"2\"}]}'),
...
(20, 'user4', '', 'user4@gmail.com', '', '', '', 0, ''),
(21, 'user2', '', 'user2@gmail.com', '', '', '', 0, '');
