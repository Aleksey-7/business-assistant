    ...
    echo "<nav aria-label='Page navigation'>";
      echo "<ul class='pagination pagination-ыь'>";
        ...
        echo "<li class='page-item'>";
          echo "<a class='page-link disabled' href='/' aria-label='Previous'>";
        ...
        echo "</li>";
          ...
          echo "<li class='page-item'>";
            echo "<a class='page-link' href='http://business-assistant.local?page=" . $prevPage . "' aria-label='Next'>";
      ...
      if ($currentPage == 1){
        echo "<li class='page-item active'><a class='page-link' href='http://business-assistant.local?page=1'>1</a></li>";
        echo "<li class='page-item " . $activeStatus2 . "'><a class='page-link' href='http://business-assistant.local?page=2'>2</a></li>";
        echo "<li class='page-item " . $activeStatus3 . "'><a class='page-link' href='http://business-assistant.local?page=3'>3</a></li>";

      // страницы от 2 и дальше, активную страницу рисуем по центру
      }else{
          echo "<li class='page-item'><a class='page-link' href='http://business-assistant.local?page=" . ( $currentPage - 1) . "'>" . ( $currentPage - 1) . "</a></li>";
          echo "<li class='page-item active'><a class='page-link' href='http://business-assistant.local?page=" . $currentPage . "'>" . $currentPage . "</a></li>";
          echo "<li class='page-item " . $activeStatus3 . "'><a class='page-link' href='http://business-assistant.local?page=" . $nextPageLink . "'>" . ($nextPage) . "</a></li>";
      }
        // предпоследняя кнопка пагинации, ведет к следующей странице
        echo "<li class='page-item'>";
          echo "<a class='page-link' href='http://business-assistant.local?page=" . $nextPageLink . "' aria-label='Next'>";
            echo "<span aria-hidden='true'>&raquo;</span>";
          echo "</a>";
          // последняя кнопка пагинации, ведет к последней странице продуктов в БД
          echo "<li class='page-item'>";
            echo "<a class='page-link' href='http://business-assistant.local?page=" . $lastPage . "' aria-label='Next'>";
